...
| **Warning:** Once the user has installed your PWA, you can't add or remove shortcuts until you update your manifest on the server and the [update algorithm](https://web.dev/learn/pwa/update) is triggered.
