...
![A website with a global header, a content area, a sidebar and a footer.](https://web.dev/static/learn/pwa/architecture/image/a-website-a-global-heade-d2ca727b1bcd4.png)
...
| **Try it:** [Service worker includes](https://developers.google.com/codelabs/pwa-training/pwa06--service-worker-includes).
...
In the [window management module](https://web.dev/learn/pwa/windows), we've already seen how the in-app browser looks when a user navigates to a different origin from an installed PWA.
