...
called the [Progressive Web App Checklist](https://web.dev/articles/pwa-checklist), to help you create a PWA that users will love.

### Core requirements

Because PWAs span all devices,
from mobile through desktop,
the core Progressive Web App Checklist is about what you need to do to make your app installable and reliable for *all* users,
